...
**Jawaban:** _Saat install Next.js, agar menggunakan JavaScript (bukan TypeScript), kita harus pilih Saat muncul pertanyaan "Would you like to use TypeScript?" → pilih No. Next.js akan otomatis membuat proyek dengan file .js bukan .ts/.tsx._
